...
if __name__ == '__main__':
    user.create_user("aarchamb", "aarchambault0@wikipedia.org")
    aarchamb_home   = {
    ...
    user.create_user("tgrimes1", "tgrimes1@hostgator.com")
    tgrimes1_home   = {
    ...
    order.checkout("aarchamb", "home", shopping_cart1, '11/18/21')
    order.checkout("tgrimes1", "home", shopping_cart2, '11/19/21')
    order.checkout("tgrimes1", "home", shopping_cart3, '11/20/21')